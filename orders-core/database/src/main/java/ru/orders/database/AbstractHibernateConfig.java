...
@EnableJpaRepositories(basePackages = "ru.orders.dbtools.repositories", entityManagerFactoryRef = "entityManagerFactoryBean")
public abstract class AbstractHibernateConfig {


    private static final String ENTITY_PACKAGE = "ru.orders.dbtools.domains";
